...
RETURN:3,
***********************************************/
int page_graduate(int *x,int* pinfo_page, int psave[], int ifin[][6], int pos[], int* template_page,int *ifadd,int *count,int turn[])
{
	
	unsigned s = 0;
	void* p;
	int i[5] = {0};
	int addlength[2] = {156,126};
	int add[2] = {0,0};
	int i1 = 65, i2 = 151, i3 = 126, i4 = 108;
	i[0] = pos[0] * i1;
	i[1] = pos[0] * i1 + pos[1] * i2;
	i[2] = i[1] + pos[5] * i[3];
	i[3] = pos[0] * i1 + pos[1] * i2 + pos[5] * i3 + pos[6] * i4;
	...
	*template_page = 3;
	...
	page_graduate_draw(*x, psave, ifin, pos);
	...
	while (1)
	{
		...
		if (MouseX > 0 && MouseX < 500 && MouseY>0 && MouseY < 90 + *x)//姓名 line(0,70+x+20,610,70+x+25);
		{
			if (mouse_press(0, 0, 500, 90 + *x) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 0, 500, 90 + *x, 1);
			}
		...
		else graduate_border(0, 0, 500, 90 + *x, 0);
		if (MouseX > 0 && MouseX < 500 && MouseY>90 + *x && MouseY < 155 + *x && pos[0] == 0)//求职意向 line(0,125+x+35-i[0],610,125+x+35-i[0]);
		{
			if (mouse_press(0, 90 + *x, 500, 160 + *x) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 97 +*x, 500, 157 + *x, 1);
			}
		...
		else graduate_border(0, 97 + *x, 500, 157 + *x, 0);
		if (MouseX > 0 && MouseX < 500 && MouseY>155 + *x - i[0] && MouseY < 311 + *x - i[0] && pos[1] == 0)//教育经历 line(0,266+x+45-i[1],610,266+x+45-i[1]);
		{
			if (mouse_press(0, 155 + *x - i[0], 500, 311 + *x - i[0]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 163 + *x - i[0], 500, 306 + *x - i[0], 1);
			}
		...
		else graduate_border(0, 163 + *x - i[0], 500, 306 + *x - i[0], 0);
		if (MouseX > 0 && MouseX < 500 && MouseY>311 + *x - i[1] && MouseY < 467 + *x - i[1] && pos[5] == 0)//在校经历 line(0,382+x+55,610,382+x+55);
		{
			if (mouse_press(0, 311 + *x - i[1], 500, 467 + *x - i[1]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 313 + *x - i[1], 500, 462 + *x - i[1], 1);
			}
		...
		else graduate_border(0, 313 + *x - i[1], 500, 462 + *x - i[1], 0);
		if (MouseX > 0 && MouseX < 500 && MouseY>467 + *x - i[2] && MouseY < 622 + *x - i[2] && pos[6] == 0)//实习经历 line(0, 480 + x + 65 , 610, 480 + x+ 65 );
		{
			if (mouse_press(0, 467 + *x- i[2], 500, 622 + *x- i[2]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 470 + *x - i[2], 500, 620 + *x - i[2], 1);
			}
			if (mouse_press(0, 467 + *x - i[2], 500, 622 + *x - i[2]) == 1)
			{
				*pinfo_page = 8;
				delay(100);
				return 11;
		...
		else graduate_border(0, 470 + *x - i[2], 500, 620 + *x - i[2], 0);
		if (MouseX > 0 && MouseX < 500 && MouseY>625 + *x - i[3]+add[0]+add[1] && MouseY < 825 + *x - i[3]+add[0]+add[1] && pos[4] == 0)//自我评价 
		{
			if (mouse_press(0, 625 + *x - i[3]+add[0]+add[1], 500, 825 + *x - i[3]+add[0]+add[1]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 627 + *x - i[3]+add[0]+add[1], 500, 820 + *x - i[3]+add[0]+add[1], 1);
			}
			if (mouse_press(0, 625 + *x - i[3]+add[0]+add[1], 500, 825 + *x - i[3]+add[0]+add[1]) == 1)
			{
				*pinfo_page = 6;
				delay(100);
				return 11;
		...
		else graduate_border(0, 627 + *x - i[3]+add[0]+add[1], 500, 820 + *x - i[3]+add[0]+add[1], 0);
		//工作信息622 + x - i[3]
		if (MouseX > 0 && MouseX < 500 && MouseY>622 + *x - i[3] && MouseY < 778 + *x - i[3] && pos[2] == 0)
		{
			if (mouse_press(0, 622 + *x - i[3], 500, 778 + *x - i[3]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 627 + *x - i[3], 500, 773 + *x - i[3], 1);
			}
			if (mouse_press(0, 622 + *x - i[3], 500, 778 + *x - i[3]) == 1)
			{
				*pinfo_page = 4;
				delay(100);
				return 11;
		...
		else graduate_border(0, 627 + *x - i[3], 500, 773 + *x - i[3], 0);
		//技能信息622 + x - i[3]+add[0]
		if (MouseX > 0 && MouseX < 500 && MouseY>622 + *x - i[3]+add[0] && MouseY < 748 + x - i[3]+add[0] && pos[3] == 0)
		{
			if (mouse_press(0, 622 + *x - i[3]+add[0], 500, 748 + *x - i[3]+add[0]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
				graduate_border(0, 627 + *x - i[3]+add[0], 500, 743 + *x - i[3]+add[0], 1);
			}
			if (mouse_press(0, 622 + *x - i[3]+add[0], 500, 748 + *x - i[3]+add[0]) == 1)
			{
				*pinfo_page = 5;
				delay(100);
				return 11;
		...
		else graduate_border(0, 627 + *x - i[3]+add[0], 500, 743 + *x - i[3]+add[0], 0);
		...
		//实习经历删除框rectangle(580,442+x-i[2],600,462+x-i[2]);
		...
		//自我评价删除框 rectangle(580, 630 + x - i[3]+add[0]+add[1], 600, 650 + x - i[3]+add[0]+add[1]);
		if (MouseX > 580 && MouseX < 600 && MouseY > 630 + *x - i[3]+add[0]+add[1] && MouseY < 650 + *x - i[3]+add[0]+add[1] && pos[4] == 0)
		{
			if (mouse_press(580, 630 + *x- i[3]+add[0]+add[1], 600, 650 + *x - i[3]+add[0]+add[1]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
			}
			if (mouse_press(580, 630 + *x - i[3]+add[0]+add[1], 600, 650 + *x - i[3]+add[0]+add[1]) == 1)
			{
				clrmous(MouseX, MouseY);
				pos[4] = 1;
				psave[5] = 0;
		...
		//工作信息删除框 rectangle(580, 627 + x - i[3], 600, 647 + x - i[3]);
		if (MouseX > 580 && MouseX < 600 && MouseY > 627 + *x - i[3] && MouseY < 647 + *x - i[3] && pos[2] == 0)
		{
			if (mouse_press(580, 627 + *x - i[3], 600, 647 + *x - i[3]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
			}
			if (mouse_press(580, 627 + *x - i[3], 600, 647 + *x - i[3]) == 1)
			{
				clrmous(MouseX, MouseY);
				pos[2] = 1;
				psave[3] = 0;
		...
		//技能信息删除框 rectangle(580, 647 + x - i[3]+add[0], 600, 667 + x - i[3]+add[0]);
		if (MouseX > 580 && MouseX < 600 && MouseY > 647 + *x - i[3]+add[0] && MouseY < 667 + *x - i[3]+add[0] && pos[3] == 0)
		{
			if (mouse_press(580, 647 + *x - i[3]+add[0], 600, 667 + *x - i[3]+add[0]) == 2)
			{
				MouseS = 1;
				newmouse(&MouseX, &MouseY, &press);
			}
			if (mouse_press(580, 647 + *x - i[3]+add[0], 600, 667 + *x - i[3]+add[0]) == 1)
			{
				clrmous(MouseX, MouseY);
				pos[3] = 1;
				psave[4] = 0;
...
RETURN:void
***********************************************/
void page_graduate_draw(int x, int psave[], int ifin[][6], int pos[])
{
	int i1 = 65, i2 = 151, i3 = 126, i4 = 108;
	int i[5] = { 0 };
	int add[2] = {0};
	...
	{
		setlinestyle(0, 0, 3);
		line(0, 412 + x + 55 - i[2], 610, 412 + x + 55 - i[2]);
		puthz(0, 417 + x + 55 - i[2], "实习经历", 24, 32, BLACK);
		setlinestyle(0, 0, 1);
	...
	{
		setlinestyle(0, 0, 3);
		line(0, 560 + x + 65 - i[3]+add[0]+add[1], 610, 560 + x + 65 - i[3]+add[0]+add[1]);
		puthz(0, 565 + x + 65 - i[3]+add[0]+add[1], "自我评价", 24, 32, BLACK);
		setlinestyle(0, 0, 1);
		rectangle(580, 630 + x - i[3]+add[0]+add[1], 600, 650 + x - i[3]+add[0]+add[1]);
		line(585, 635 + x - i[3]+add[0]+add[1], 595, 645 + x - i[3]+add[0]+add[1]);
		line(595, 635 + x - i[3]+add[0]+add[1], 585, 645 + x - i[3]+add[0]+add[1]);
	}
    if (pos[2] == 0)//622 + x - i[3]
	{
		setlinestyle(0, 0, 3);
		line(0, 622 + x - i[3], 610, 622 + x - i[3]);
		puthz(0, 627 + x - i[3], "工作经历", 24, 32, BLACK);
		puthz(0, 657 + x - i[3], "公司名称", 16, 18, BLACK);
		puthz(0, 682 + x - i[3], "职位名称", 16, 18, BLACK);
		puthz(400, 682 + x - i[3], "开始时间", 16, 18, BLACK);
		puthz(500, 682 + x - i[3], "结束时间", 16, 18, BLACK);
		setlinestyle(0, 0, 1);
		line(480, 691 + x - i[3], 490, 691 + x - i[3]);
		setlinestyle(0, 0, 1);
		rectangle(580, 627 + x - i[3], 600, 647 + x - i[3]);
		line(585, 632 + x - i[3], 595, 642 + x - i[3]);
		line(595, 632 + x - i[3], 585, 642 + x - i[3]);
	}
	if (pos[3] == 0)
	{
		setlinestyle(0, 0, 3);
		line(0, 622 + x - i[3]+add[0], 610, 622 + x - i[3]+add[0]);
		puthz(0, 627 + x - i[3]+add[0], "技能证书", 24, 32, BLACK);
		setlinestyle(0, 0, 1);
		rectangle(580, 647 + x - i[3]+add[0], 600, 667 + x - i[3]+add[0]);
		line(585, 652 + x - i[3]+add[0], 595, 662 + x - i[3]+add[0]);
		line(595, 652 + x - i[3]+add[0], 585, 662 + x - i[3]+add[0]);
	}
	...
	{
		put_intern_info(495 + x - i[2], ifin);
	}
	if (psave[5] == 1 && pos[4] == 0)
	{
		put_comment_info(655 + x - i[3], ifin);
	}
    if (psave[3] == 1&&pos[2] == 0)
	{
		put_experience_info(622+35 + x - i[3],ifin);
	}
	if (psave[4] == 1&&pos[3] == 0)
	{
		put_skill_info(622 + x - i[3]+add[0],ifin);
	}
...
RETURN:void
***********************************************/
void graduate_border(int x1, int y1, int x2, int y2, int x)
{
	setlinestyle(0, 0, 1);
	if (x == 1)
	{
